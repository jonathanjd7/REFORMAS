...
export default function Projects() {
  ...
  return (
    <div className="bg-white pt-8 pb-4 sm:pt-12 sm:pb-32 dark:bg-gray-900">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-xl lg:text-xl font-semibold leading-7 text-primary-600 dark:text-primary-400 text-center mb-4">Nuestros Proyectos</h2>
