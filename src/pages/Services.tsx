...
export default function Services() {
  return (
    <div className="bg-white pt-12 pb-24 sm:pt-12 sm:pb-32 dark:bg-gray-900">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-2xl font-semibold leading-7 text-primary-600 dark:text-primary-400 text-center">Nuestros Servicios</h2>
          <p className="mt-5 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-white">
